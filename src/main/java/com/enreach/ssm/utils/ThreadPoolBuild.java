 ...
 */
public final class ThreadPoolBuild extends java.util.concurrent.ThreadPoolExecutor {
    ...
    public ThreadPoolBuild(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit,
    ...
    protected static class ControllableQueue extends LinkedBlockingQueue<Runnable> {
        ...
        private transient volatile ThreadPoolBuild parent = null;

        public ControllableQueue(int capacity) {
            super(capacity);
        }

        public void setParent(ThreadPoolBuild tp) {
            parent = tp;
        }
