...
import com.enreach.ssm.utils.Platforms;
...
//#endregion
    ...
    public static String simplifyPath(String path) {
        return com.google.common.io.Files.simplifyPath(path);
    }
    ...
    public static String concat(String baseName, String... appendName) {
        ...
        if (StringUtils.endsWith(baseName, String.valueOf(Platforms.FILE_PATH_SEPARATOR_CHAR))) {
    ...
    public static String getParentPath(String path) {
        ...
        parentPath = StringUtils.removeEnd(parentPath, String.valueOf(Platforms.FILE_PATH_SEPARATOR_CHAR));
