...
import com.enreach.ssm.utils.RandomUtil;
...
public class CryptoUtil {
    ...
    public static byte[] generateHmacSha1Key() {
        return getBytes(DEFAULT_HMACSHA1_KEYSIZE, HMACSHA1_ALG);
    }
    ...
    public static byte[] generateAesKey(int keySize) {
        return getBytes(keySize, AES_ALG);
    }
    ...
    private static byte[] getBytes(int keySize, String aesAlg) {
        try {
            KeyGenerator keyGenerator = KeyGenerator.getInstance(aesAlg);
